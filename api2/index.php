...
<body>
<h1>API 3.0.0 injection</h1>
<p>Before using this tool, please carefully read the following caution:</p>
<ul>
	<li>This tool only <em>forces</em> the plugin to say that it supports API 3.0.0 (PHP 7 update), and optionally,
...
<form action="updated.phar" method="post" enctype="multipart/form-data">
	...
	<ul>
		<li>
			...
			don't want API <code>3.0.0</code>.
			I want something else: <input id="apiInput" type="text" name="api" value="3.0.0" disabled>
		</li>
		<li>
